...
const SiderNav: React.FC<Props> = (props: any) => {
  ...
  return (
    <Sider className={styles.basicLayoutSider}>
      ...
      >
        <div className="flex-box-center circle-box" style={{ borderColor: `${localStorage.getItem('theme-mode') === 'dark' ? '#ccc' : '#000'}` }}>
